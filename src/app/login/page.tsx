    ...
    <div className="min-h-[100dvh] bg-white flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mb-9">
          ...
          <div>
            <p className="text-[20px] font-extrabold tracking-[-0.5px]">BMB에 오신 걸 환영해요</p>
            <p className="text-[13px] text-text-muted mt-0.5">로그인하고 나만의 베이커리를 찾아보세요</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          {[
            ...
            <button
              key={label}
              className={`w-full h-[50px] rounded-[14px] ${bg} ${color} text-[14px] font-semibold flex items-center justify-center gap-2.5`}
            >
